...
### Tujuan Praktikum
Praktikum 2 ini bertujuan untuk memisahkan data layer dari view layer menggunakan **InheritedWidget** dan **InheritedNotifier**. Dengan cara ini, kita dapat mengelola state aplikasi dengan lebih terstruktur dan scalable.
...
1. **`PlanProvider`**: Nama class custom kita
...
Karena aplikasi kita butuh reactive state yang update otomatis saat data berubah, maka **InheritedNotifier** yang digunakan.
...
Kita tidak store `finalPrice` di variable terpisah karena:
...
![Langkah 9 - ValueListenableBuilder Demo](./img/langkah9_praktikum2.gif)
...
1. **Empty State**: 
   - Buka app → "0 out of 0 tasks" ✅

2. **Add Tasks**:
   - Tap (+) 3x → "0 out of 3 tasks" ✅

3. **Complete Tasks**:
   - Centang 1 → "1 out of 3 tasks" ✅
   - Centang 1 lagi → "2 out of 3 tasks" ✅

4. **Uncomplete Tasks**:
   - Uncheck 1 → "1 out of 3 tasks" ✅

5. **Mixed Operations**:
   - Add 2 task → "1 out of 5 tasks" ✅
   - Centang semua → "5 out of 5 tasks" ✅

**Hasil:** Semua skenario berjalan sempurna, UI reactive dan smooth! 🎉

---

**Kesimpulan Langkah 9:**

Langkah 9 adalah refactoring Praktikum 2, di mana kita berhasil:
